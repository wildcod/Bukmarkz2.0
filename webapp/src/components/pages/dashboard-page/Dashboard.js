...
const Dashboard = ({ auth }) => {
  ...
  return (
    <div
      className={s.dashBoardWrapper}
      style={{ background: `url(${auth.backgroundPreferredImageUrl}) fixed` }}
    >
      <div className={s.navBar}>
        ...
        <div>
          <span>
            {auth?.user?.is_subscribed ? "Premium Account" : "Basic Account"}
          </span>
        </div>
      </div>
