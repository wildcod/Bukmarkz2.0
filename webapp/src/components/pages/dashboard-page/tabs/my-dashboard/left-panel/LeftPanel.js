...
import {deleteRecommendation, getRecommendations} from "../../../../../../redux/reducers/recommendations";
                ...
                hasSub ?
                    <div className={s.hasSub}>
                        ...
                        <div className={s.askBtn}>
                            <Button onClick={() => setAskOpenModal(true)} label={t('ask_button')} />
                        </div>
...
const LeftPanel = ({
   ...
   t
    ...
    return (
        <div>
            <Card
                heading={t('recommendation_card_title')}
                hasSub={false}
            >
            ...
            <Card
             ...
             />
            <Modal
                openModal={askOpenModal}
                onClose={() => setAskOpenModal(false)}
            >
